class ChromaticScale
{
    constructor()
    {
        ...
        // Chords
        this.major_chords = chord_names.map(chord => chord);
        this.minor_chords = chord_names.map(chord => chord + 'm');
        ...
        this.flat_names.forEach((name, i) => this.sharp_notes_reverse_lookup[name] = i);
        ...
        natural_names.forEach((name, i) => this.solfege_notes_lookup[name] = this.solfege_names[i]);
